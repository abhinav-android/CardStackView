...
public abstract class StackAdapter<T> extends CardStackView.Adapter<CardStackView.ViewHolder> {
    ...
    public void onBindViewHolder(CardStackView.ViewHolder holder, int position) {
        ...
        List<T> dataList = this.getList();
        this.bindView(dataList, data, position, holder);
    }

    public abstract void bindView(List<T> dataList, T data, int position, CardStackView.ViewHolder holder);
